  ...
  <div class="card bg-white rounded-2xl p-8 max-w-md w-full">
    ...
    <div id="successMessage" class="hidden fade-in">
      ...
      <div class="mt-6 text-center">
        <a href="#" class="text-primary font-medium hover:underline">Kembali ke halaman login</a>
      </div>
    </div>

    <!-- Reset Password Form (initially visible) -->
  ...
  <script>
    ...
    form.addEventListener('submit', function(e) {
      ...
      setTimeout(() => {
        ...
        // Reset button state (in case of going back)
