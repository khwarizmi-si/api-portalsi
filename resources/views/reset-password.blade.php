...
<body class="flex items-center justify-center p-4">
    ...
    <div class="card max-w-md w-full p-8">
        ...
        <form id="resetPasswordForm">
            <!-- CSRF Token akan diambil dari meta tag atau input hidden -->
    ...
    <script>
        ...
        function getCsrfToken() {
            ...
            // Jika tidak ada di meta tag, coba dari input hidden di form
            const formToken = document.querySelector('input[name="_token"]');
            if (formToken) {
                return formToken.value;
            }
            
            // Jika masih tidak ditemukan, gunakan nilai default atau kosong
            return '';
        }
        
        // Set CSRF token saat halaman dimuat
        ...
        resetPasswordForm.addEventListener('submit', async function(event) {
            ...
            const resetPasswordApiUrl = '/submit-reset-password';
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const errorMsg = data.message || data.error || 'Gagal mereset password. Silakan coba lagi.';
                    showMessage(errorMsg, 'error');
                    
                    // Jika error karena token CSRF, refresh halaman
