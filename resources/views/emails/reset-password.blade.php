...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <p style="margin:0 0 10px 0; font-size:13px; line-height:20px; color:#2563eb; font-weight:700; text-transform:uppercase; letter-spacing:0.8px;">
                Keamanan akun
            </p>
    ...
    <tr>
        <td align="center" style="padding:8px 0 28px 0;">
            <a href="{{ $url }}" class="email-button" style="display:inline-block; min-width:220px; padding:15px 24px; background:#2563eb; color:#ffffff; border-radius:7px; font-size:16px; line-height:20px; font-weight:700; text-align:center; text-decoration:none;">
                Reset Password
            </a>
        </td>
    </tr>
